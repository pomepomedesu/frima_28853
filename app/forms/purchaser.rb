class Purchaser
  ...
  attr_accessor :user_id,:item_id,:buyer_id, :postal_code, :prefecture_id, :city, :house_number, :building_name,:phone_number, :token
  ...
  with_options presence: true do
    ...
    validates :phone_number,  format: { with: VALID_PHONE_REGEX }, length: { maximum: 11, message: "is invalid."}
  end
